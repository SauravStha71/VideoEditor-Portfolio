...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="overflow-hidden mb-1 sm:mb-4">
          <motion.h1
            ...
            style={{ fontSize: 'clamp(3rem, 12vw, 14rem)', color: 'var(--text)' }}
          >
            <span className="italic">Dipen</span>
          </motion.h1>
        </div>
      ...
      >
        <p className="font-mono text-xs tracking-widest uppercase [writing-mode:vertical-rl] rotate-180"
          style={{ color: 'var(--text-muted)' }}>
          Based in Ontario, Canada
        </p>
      </motion.div>
